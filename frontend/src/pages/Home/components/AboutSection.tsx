    ...
    return (
        <div className="container mx-auto px-4 mt-35">
            ...
            <div className="mb-[60px]">
                ...
                <p className="text-center text-lg max-w-2xl mx-auto text-[#0A0E29] ">Empowering the next generation of engineers through structured
                    learning and a unified platform.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[30px] lg:gap-[60px] mb-[100px]">
                <div className="rounded-[24px] bg-gradient-to-t from-[#D6DAF5] to-[#FFFFFF] py-[16px] px-[20px] border border-white flex flex-col gap-2 hover:from-[#8490E1] hover:to-[#FDFDFD]">
                    <div className="bg-[#D6DAF5] rounded-[16px] w-[48px] h-[48px] flex items-center justify-center text-[#2839A4]">
                        <Target />
                    </div>
                    <h2 className="text-xl font-bold">Our Mission</h2>
                    <p className="text-[#141C52]">To provide a unified, intuitive platform for accessible
                ...
                <div className="rounded-[24px] bg-gradient-to-t from-[#D6DAF5] to-[#FFFFFF] py-[16px] px-[20px] border border-white flex flex-col gap-2 hover:from-[#8490E1] hover:to-[#FDFDFD]">
                    ...
                    <p className="text-[#141C52]">To become the global standard for student-led technical
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[30px] lg:gap-[60px]">
                <div className="rounded-[24px] bg-gradient-to-t from-[#D6DAF5] to-[#FFFFFF] py-[16px] px-[20px] border border-white flex flex-col gap-2 hover:from-[#8490E1] hover:to-[#FDFDFD]">
                    <div className=" rounded-[16px] w-[48px] h-[48px] flex items-center justify-center text-[#2839A4]">
                        <GraduationCap />                    </div>
                    <h2>Structured Courses</h2>
                    <p className="text-[#141C52]">Organized curriculum paths tailored for specific engineering majors.</p>
                </div>
                <div className="rounded-[24px] bg-gradient-to-t from-[#D6DAF5] to-[#FFFFFF] py-[16px] px-[20px] border border-white flex flex-col gap-2 hover:from-[#8490E1] hover:to-[#FDFDFD]">
                    <div className=" rounded-[16px] w-[48px] h-[48px] flex items-center justify-center text-[#2839A4]">
                        <ChartColumnBig /></div>
                ...
                <div className="rounded-[24px] bg-gradient-to-t from-[#D6DAF5] to-[#FFFFFF] py-[16px] px-[20px] border border-white flex flex-col gap-2 hover:from-[#8490E1] hover:to-[#FDFDFD]">
                    ...
                    <p className="text-[#141C52]">Connect with peers and mentors to solve
                ...
                <div className="rounded-[24px] bg-gradient-to-t from-[#D6DAF5] to-[#FFFFFF] py-[16px] px-[20px] border border-white flex flex-col gap-2 hover:from-[#8490E1] hover:to-[#FDFDFD]">
                    ...
                    <p className="text-[#141C52]">Access a vast collection of textbooks and research papers</p>
                </div>
                <div className="rounded-[24px] bg-gradient-to-t from-[#D6DAF5] to-[#FFFFFF] py-[16px] px-[20px] border border-white flex flex-col gap-2 hover:from-[#8490E1] hover:to-[#FDFDFD]">
                    <div className=" rounded-[16px] w-[48px] h-[48px] flex items-center justify-center text-[#2839A4]">
                        <BookCheck /></div>
                    <h2>Mock Exams</h2>
                    <p className="text-[#141C52]">Prepare for finals with real-time
                ...
                <div className=" rounded-[24px] bg-gradient-to-t from-[#D6DAF5] to-[#FFFFFF] py-[16px] px-[20px] border border-white flex flex-col gap-2 hover:from-[#8490E1] hover:to-[#FDFDFD]">
                    ...
                    <p className="text-[#141C52]">Real-time tools for group projects and
