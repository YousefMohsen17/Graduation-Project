...
export default function ButtonLink({
  ...
  const baseClasses = `
    ...
    ${variant === "solid"
      ? "bg-gradient-to-t from-[#0A0E29] to-[#1E2A7B] text-[#EAEDFA] hover:from-[#141C52] hover:to-[#5B6CD7]"
      : "bg-[#D6DAF5] text-[#0A0E29] border border-[#0A0E29] hover:text-[#5B6CD7] hover:border-[#5B6CD7]"}
    ${className}
  `;
